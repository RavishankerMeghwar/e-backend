...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 06, 2025 at 05:12 PM
...
CREATE TABLE `marks` (
  ...
  `objective_marks` int(11) DEFAULT NULL,
...
CREATE TABLE `questions` (
  `id` int(11) NOT NULL,
  `test_id` int(11) DEFAULT NULL,
  `question_type` enum('objective','written') DEFAULT NULL,
...
CREATE TABLE `tests` (
  ...
  `subject_id` int(11) DEFAULT NULL,
  `teacher_id` int(11) DEFAULT NULL,
  `test_type` enum('objective','written','both') DEFAULT NULL,
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `role`, `token`, `created_at`) VALUES
(2, 'Admin', '', 'admin@gmail.com', '$2y$10$jXkoasrmyY8LbnPOMA9Qt.phaX7y7E0400SCwawTFCLKTZZRPZnt2', 'admin', '252882', '2025-08-06 13:02:21');
...
ALTER TABLE `marks`
  ...
  ADD CONSTRAINT `marks_ibfk_2` FOREIGN KEY (`test_id`) REFERENCES `tests` (`id`);
